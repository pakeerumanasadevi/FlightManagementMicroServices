...
public class FlightScheduleController {
	...
	public ResponseEntity<String> addFlightSchedule(@Valid @RequestBody() FlightSchedule flightSchedule) {
		try {
			...
			return new ResponseEntity<>(ex.getMessage() + "Flight Schedule details already added",
	...
	public ResponseEntity<Object> updateFlightSchedule(@PathVariable("id") String scheduleId,
			@RequestBody FlightSchedule flightSchedule) throws FlightScheduleNotFoundException {
